import {
  ...
  const getTutorialBySlugWithMarkdown = async (slug : string) : Promise<Tutorial>=> {
  ...
  export { getTutorialFileNames, getTutorial, getTutorials, getAllTutorialSlugs as getAllTutorialSlugs, getTutorialBySlug, getTutorialBySlugWithMarkdown };
